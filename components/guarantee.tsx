      ...
      <div className="mobile-content">
        ...
        >
          ...
          <div className="text-center space-y-6 sm:space-y-8 pt-12 sm:pt-16">
            ...
            <div className="space-y-3 sm:space-y-4 text-sm sm:text-base" style={{ color: '#5B6B8A' }}>
              <p className="leading-relaxed">
                Acesse o Guia Visual de Anatomia Dental, explore os seis volumes e veja como o material funciona na prática. Se dentro de 7 dias você entender que ele não atende às suas expectativas, poderá solicitar o reembolso dentro do prazo de garantia.
              </p>
            </div>
          </div>
        </div>
